...
def precompute_theta_pos_frequencies(head_dim: int , seq_len: int , device: str , theta: float = 10000.0):
    ...
    # We can compute numbers in the polar form c = R * exp(i * m * theta) , where R = 1 as follow:
...
class SelfAttention(nn.Module):
    def __init__(self , args: ModelArgs):
        ...
        # Indicate how many times the heads of keys and values should be repeated to match the head of the queries
        self.n_rep = self.n_heads_q // self.n_kv_heads
        # Indicate the dimension for each head
...
class FeedForward(nn.Module):
    ...
    def __init__(self , args: ModelArgs):
        ...
        # Round the hidden dim to the nearest multiple of parameter
